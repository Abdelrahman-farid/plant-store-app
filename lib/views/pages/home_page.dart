...
class _HomePageState extends State<HomePage> {
  ...
  List<Plant> get _filteredPlantList {
    if (selectedIndex == 0) {
      // Show all plants for "Recommended"
      return Plant.plantList;
    } else {
      // Filter by selected category
      final selectedCategory = _plantTypes[selectedIndex];
      return Plant.plantList
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          child: DetailPage(
                            plantId: _filteredPlantList[index].plantId,
                          ),
                      ...
                      child: Stack(
                        children: [
                                ...
                                onPressed: () {
                                  setState(() {
                                    bool isFavorited = toggleIsFavorited(
                                        _filteredPlantList[index].isFavorated);
                                    _filteredPlantList[index].isFavorated = isFavorited;
                                  });
                                },
                                icon: Icon(
                                  _filteredPlantList[index].isFavorated == true
                                      ? Icons.favorite
                          ...
                          Positioned(
                            ...
                            top: 50,
                            bottom: 50,
                            child: Image.asset(_filteredPlantList[index].imageURL),
                          ),
                          Positioned(
                            bottom: 15,
                            left: 20,
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                r'$' + _filteredPlantList[index].price.toString(),
                                style: TextStyle(
                                  color: Constants.primaryColor,
                                  fontSize: 16,
                                ),
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontSize: 16,
                                        color:
                                            Constants.blackColor.withOpacity(.6),
                                      ),
                                    ),
                                  ],
                                ),
